...
int main()
{
    ...
    std::cout << "Test 000 Straight push_back" << std::endl;
    start = get_time();
    for (int i = 0; i < n; i++)
    {
    ...
    std::cout << "Test 001 Straight pop_back" << std::endl;
    ...
    std::cout << "Test 002 Straight resize up" << std::endl;
    ...
    std::cout << "Test 003 Random pop/push equal amount" << std::endl;
    ...
    std::cout << "Test 005 Random pop/push more push" << std::endl;
    ...
    std::cout << "Test 005 Random pop/push much more push" << std::endl;
